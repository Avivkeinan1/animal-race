...
const neigh = document.getElementById("horse-sound");
const woof = document.getElementById("dog-sound");
const quack = document.getElementById("duck-sound");
const cluck = document.getElementById("chick-sound");
let reset = false;
const runners = {
  horse: {
    name: "Horse",
